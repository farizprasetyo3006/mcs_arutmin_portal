...
namespace MCSWebApp.Controllers.API.Location
{
    ...
    [ApiController]
    public class ReadytoGetController : ApiBaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;

        public ReadytoGetController(IConfiguration Configuration, IOptions<SysAdmin> SysAdminOption)
        ...
        public async Task<object> ReadytoGet(string Id, DataSourceLoadOptions loadOptions)
        {
            return await DataSourceLoader.LoadAsync(dbContext.vw_ready_to_get
                .Where(o => o.organization_id == CurrentUserContext.OrganizationId
                    && o.is_ready_to_get == true
        ...
        public async Task<object> DataDetail(string Id, DataSourceLoadOptions loadOptions)
        {
            return await DataSourceLoader.LoadAsync(
                dbContext.ready_to_get.Where(o => o.id == Id),
                loadOptions);
        }
        ...
        public async Task<IActionResult> InsertData([FromForm] string values)
        {
            ...
            try
            {
				if (await mcsContext.CanCreate(dbContext, nameof(ready_to_get),
        ...
        public async Task<IActionResult> UpdateData([FromForm] string key, [FromForm] string values)
        {
            ...
            try
            {
                var record = dbContext.ready_to_get
                    .Where(o => o.id == key)
                    .FirstOrDefault();
                if (record != null)
                {
        ...
        public async Task<IActionResult> DeleteData([FromForm] string key)
        {
            ...
            try
            {
                ...
                if (record != null)
                {
                    dbContext.ready_to_get.Remove(record);
                    await dbContext.SaveChangesAsync();
                }
        ...
        [HttpPost("SaveData")]
        public async Task<IActionResult> SaveData([FromBody] ready_to_get Record)
        {
            try
            {
                var record = dbContext.ready_to_get
                ...
                else if (await mcsContext.CanCreate(dbContext, nameof(ready_to_get),
                    CurrentUserContext.AppUserId) || CurrentUserContext.IsSysAdmin)
                {
                    record = new ready_to_get();
                    record.InjectFrom(Record);
