...
namespace MCSWebApp.Controllers.API.Delay
{
    ...
    public class DelayDetailsController : ApiBaseController
    {
        ...
        {
            return await DataSourceLoader.LoadAsync(dbContext.vw_delay_details
                .Where(o => o.organization_id == CurrentUserContext.OrganizationId)
                .Where(o => o.business_unit_id == HttpContext.Session.GetString("BUSINESS_UNIT_ID") || CurrentUserContext.IsSysAdmin)
                .Where(o => o.delay_id == delayId),
                    loadOptions);
        }
        ...
        public async Task<object> LocationIdLookup(string Id, DataSourceLoadOptions loadOptions)
        {
            try
            {
                var lookup = dbContext.vw_location
                    .Where(o => o.organization_id == CurrentUserContext.OrganizationId
        ...
        public async Task<IActionResult> SaveData([FromBody] delay_details Record)
        {
            try
            {
                ...
                else if (await mcsContext.CanCreate(dbContext, nameof(delay_details),
                    CurrentUserContext.AppUserId) || CurrentUserContext.IsSysAdmin)
                {
