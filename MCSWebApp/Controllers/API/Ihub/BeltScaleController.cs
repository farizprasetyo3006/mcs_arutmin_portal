...
namespace MCSWebApp.Controllers.API.Ihub
{
    ...
    [ApiController]
    public class BeltScaleController : ApiBaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;

        public BeltScaleController(IConfiguration Configuration, IOptions<SysAdmin> SysAdminOption)
        ...
        {
            return await DataSourceLoader.LoadAsync(dbContext.vw_belt_scale
        ...
        public async Task<object> DataDetail(string Id, DataSourceLoadOptions loadOptions)
        {
            return await DataSourceLoader.LoadAsync(
                dbContext.vw_belt_scale.Where(o => o.id == Id),
                loadOptions);
        }
        ...
        public async Task<IActionResult> List([FromQuery] string q)
        {
            try
            {
                var rows = dbContext.vw_belt_scale.AsNoTracking();
        ...
        public async Task<IActionResult> Detail(string Id)
        {
                ...
                || CurrentUserContext.IsSysAdmin)
            {
                try
                {
                    var record = await dbContext.vw_belt_scale
                        .Where(o => o.id == Id
