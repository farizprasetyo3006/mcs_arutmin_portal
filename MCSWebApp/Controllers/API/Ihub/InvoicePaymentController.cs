...
namespace MCSWebApp.Controllers.API.Ihub
{
    ...
    [ApiController]
    public class InvoicePayment : ApiBaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;

        public InvoicePayment(IConfiguration Configuration, IOptions<SysAdmin> SysAdminOption)
        ...
        {
            return await DataSourceLoader.LoadAsync(dbContext.sip_logs  
        ...
        public async Task<object> DataGrid(string tanggal1, string tanggal2, DataSourceLoadOptions loadOptions)
        {
            ...
            return await DataSourceLoader.LoadAsync(dbContext.sip_logs
                .Where(o =>o.created_on >= dt1 && o.created_on <= dt2),
                loadOptions);
        }
        ...
        public async Task<object> DataDetail(string Id, DataSourceLoadOptions loadOptions)
        {
            return await DataSourceLoader.LoadAsync(
                dbContext.sip_logs.Where(o => o.id == Id),
                loadOptions);
        }
        ...
        public async Task<IActionResult> InsertData([FromForm] string values)
        {
            ...
            try
            {
                if (await mcsContext.CanCreate(dbContext, nameof(sip_logs),
                    CurrentUserContext.AppUserId) || CurrentUserContext.IsSysAdmin)
                {
                    var record = new sip_logs();
        ...
        public async Task<IActionResult> DeleteData([FromForm] string key)
        {
            ...
            try
            {
                ...
                if (record != null)
                {
                    dbContext.sip_logs.Remove(record);
                    await dbContext.SaveChangesAsync();
                }
        ...
        public async Task<object> TransactionIdLookup(DataSourceLoadOptions loadOptions)
        {
            try
            {
                var lookup = dbContext.sip_logs
                    .Where(o => o.organization_id == CurrentUserContext.OrganizationId)
                    .Select(o => new { Value = o.id, Text = o.sales_invoice_number });
