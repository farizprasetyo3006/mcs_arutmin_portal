...
namespace MCSWebApp.Controllers.API.Sales
{
    ...
    [ApiController]
    public class SalesInvoiceTraceElementController : ApiBaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;
        string AttachmentFolder = "salesinvoiceattachment";

        public SalesInvoiceTraceElementController(IConfiguration Configuration, IOptions<SysAdmin> SysAdminOption)
        ...
        public async Task<object> DataGrid(DataSourceLoadOptions loadOptions)
        {
            try
            {                
                return await DataSourceLoader.LoadAsync(dbContext.sales_invoice_trace_element
        ...
        public async Task<object> DataGridAttachments(DataSourceLoadOptions loadOptions, [FromQuery] string salesInvoiceId)
        {
            try
            {
                return await DataSourceLoader.LoadAsync(
                    dbContext.vw_sales_invoice_trace_element
        ...
        {
            return await DataSourceLoader.LoadAsync(
                dbContext.sales_invoice_trace_element.Where(o => o.sales_invoice_id == Id),
                loadOptions);
        }
        ...
        {
            return await DataSourceLoader.LoadAsync(
                dbContext.sales_invoice_trace_element.Where(o => o.sales_invoice_id == custId),                    
                loadOptions);
        }
        ...
        public async Task<object> InsertAttachment(dynamic FileDocument)
        {
            ...
            try
            {
                    ...
                    CurrentUserContext.AppUserId) || CurrentUserContext.IsSysAdmin)
                {
                    ...
                    var salesInvoiceAttachmentRecord = new sales_invoice_trace_element()
                    {
                    ...
                    dbContext.sales_invoice_trace_element.Add(salesInvoiceAttachmentRecord);
        ...
        public async Task<IActionResult> DeleteData([FromForm] string key)
        {
            ...
            try
            {
                var record = dbContext.sales_invoice_trace_element
                    .Where(o => o.id == key)
                    .FirstOrDefault();
                if (record != null)
                {

                    dbContext.sales_invoice_trace_element.Remove(record);
                    await dbContext.SaveChangesAsync();
        ...
        public async Task<IActionResult> DownloadDocument(string Id)
        {
            ...
            try
            {
                var record = await dbContext.sales_invoice_trace_element
                    .Where(o => o.id == Id)
                    .FirstOrDefaultAsync();
                if (record != null)
                {
