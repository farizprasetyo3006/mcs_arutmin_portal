...
namespace MCSWebApp.Controllers.API.Sales
{
    ...
    public class SalesOrderDetailController : ApiBaseController
    {
        ...
        public SalesOrderDetailController(IConfiguration Configuration, IOptions<SysAdmin> SysAdminOption)
        ...
        public async Task<object> DataGrid(DataSourceLoadOptions loadOptions)
        {
            try
            {
                return await DataSourceLoader.LoadAsync(dbContext.sales_order_detail
        ...
        public async Task<object> DataDetail(string Id, DataSourceLoadOptions loadOptions)
        {
            return await DataSourceLoader.LoadAsync(
                dbContext.sales_order_detail.Where(o => o.id == Id),
                loadOptions);
        }
        ...
        public async Task<IActionResult> InsertData([FromForm] string values)
        {
            ...
            try
            {
				if (await mcsContext.CanCreate(dbContext, nameof(sales_order_detail),
					CurrentUserContext.AppUserId) || CurrentUserContext.IsSysAdmin)
				{
                    var record = new sales_order_detail();
        ...
        public async Task<IActionResult> DeleteData([FromForm] string key)
        {
            ...
            try
            {
                ...
                if (record != null)
                {
                    dbContext.sales_order_detail.Remove(record);
                    await dbContext.SaveChangesAsync();
                }
        ...
        public async Task<object> BySalesOrderId(string Id, DataSourceLoadOptions loadOptions)
        {
            try
            {
                return await DataSourceLoader.LoadAsync(
                    dbContext.sales_order_detail.Where(o => o.organization_id == CurrentUserContext.OrganizationId
                        && o.sales_order_id == Id),
                    loadOptions);
            }
            catch (Exception ex)
