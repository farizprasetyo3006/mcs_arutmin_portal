$(function () {
    ...
    $("#grid").dxDataGrid({
        ...
        onEditorPreparing: function (e) {
            ...
            if (e.parentType === "dataRow" && e.dataField == "bank_id") {
                ...
                e.editorOptions.onValueChanged = async function (e) { // Overiding the standard handler
                    ...
                    if (recordId != null) 
                        await $.ajax({
                            url: '/api/General/Bank/DataDetail?Id=' + recordId,
                            type: 'GET',
                            ...
                            success: function (r) {
                                grid.cellValue(index, "swift_code", r.data[0].bank_code);
                                grid.cellValue(index, "branch_information", r.data[0].address);
                                grid.cellValue(index, "bank_id", recordId)
