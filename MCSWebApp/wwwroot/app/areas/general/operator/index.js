$(function () {
    ...
    var areaName = "Operator";
    var entityName = "Operator";
    ...
    $("#dt-grid").dxDataGrid({
        ...
        columns: [
            ...
            {
                dataField: "is_foreman",
                dataType: "boolean",
                caption: "Is Foreman",
            },
            {
                dataField: "is_port_captain",
                dataType: "boolean",
                caption: "Is Port Captain",
            }
        ],
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Operator/Operator/UploadDocument",
                type: 'POST',
                cache: false,
