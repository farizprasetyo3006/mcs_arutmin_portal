$(function () {
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            },
            {
                ...
                validationRules: [{
                    type: "required",
                    message: "The Employee Name field is required."
                }]
            },
            {
                dataField: "address",
        ...
        onEditorPreparing: function (e) {
            ...
            if (e.parentType === "dataRow" && (e.dataField === "employee_number" || e.dataField === "employee_name")) {
                e.editorOptions.disabled = e.row.data.employee_number;
            }
        },
        export: {
            enabled: true,
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/General/Employee/UploadDocument",
                type: 'POST',
                cache: false,
