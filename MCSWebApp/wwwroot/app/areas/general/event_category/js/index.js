    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            },
            {
                ...
                dataType: "text",
                caption: "Event Definition Category",
                formItem: {
                    colSpan: 2
                },
                validationRules: [{
        ...
        onEditorPreparing: function (e) {
            ...
            if (e.parentType === "dataRow" && e.dataField == "event_category_code") {
                e.editorOptions.disabled = e.row.data.event_category_code != null
            }
        },
