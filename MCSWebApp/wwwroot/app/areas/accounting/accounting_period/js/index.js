$(function () {
    ...
    var areaName = "Accounting";
    var entityName = "AccountingPeriod";
        ...
        columns: [
            {
                ...
                dataType: "string",
                caption: "Accounting Period Name",
                validationRules: [{
                    type: "required",
                    message: "The Accounting Period Name field is required."
                }],
                sortOrder: "asc"
            },
            {
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Accounting/AccountingPeriod/UploadDocument",
                type: 'POST',
                cache: false,
