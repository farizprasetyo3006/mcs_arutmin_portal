$(document).ready(function () {
    ...
    let salesPlanSnapshotForm = $("#sales-plan-snapshot-form").dxForm({
        ...
        onInitialized: async function () {
            ...
            // Get salesPlanSnapshot data
            await $.ajax({
                method: "GET",
                url: "/Api/Planning/SalesPlanSnapshot/DataDetail?Id=" + salesPlanSnapshotId,
                cache: false,
                ...
                let salesPlanSnapshot = response.data[0]

                salesPlanSnapshotForm.updateData({
                    "snapshot_name": salesPlanSnapshot.snapshot_name,
                    "sales_plan_id": salesPlanSnapshot.sales_plan_id,
                    "notes": salesPlanSnapshot.notes
                })

                renderMonthlyData(JSON.parse(salesPlanSnapshot.data))
                renderTotalData(JSON.parse(salesPlanSnapshot.data))
            })
