$(function () {
    ...
    var entityName = "AdvanceContractReference";
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
...

            {
                dataField: "name",
                dataType: "string",
                caption: "Advance Contract Reference Name",
                formItem: {
                    colSpan: 2
                },
                validationRules: [{
    ...
    function createChargesTabTemplate(masterDetailData) {
        return function () {
            ...
            //console.log(currentRecord.advance_contract_id);
            let detailName = "AdvanceContractReferenceDetail";
            ...
            return $("<div>")
                .dxDataGrid({
                    ...
                    columns: [
                        ...
                        {
                            dataField: "advance_contract_charge_id",
                            dataType: "text",
                            caption: "Charge Name",
                            validationRules: [{
                                type: "required",
                            ...
                            lookup: {
                                dataSource: DevExpress.data.AspNet.createStore({
                                    key: "value",
                                    loadUrl: urlDetail + "/AdvanceContractChargeIdLookup/" + currentRecord.advance_contract_item_id,
                                    onBeforeSend: function (method, ajaxOptions) {
                                        ajaxOptions.xhrFields = { withCredentials: true };
                                        ajaxOptions.beforeSend = function (request) {
                                            request.setRequestHeader("Authorization", "Bearer " + token);
                    ...
                    onInitNewRow: function (e) {
                        e.data.advance_contract_reference_id = currentRecord.id;
                    },
                    onExporting: function (e) {
                        var workbook = new ExcelJS.Workbook();
                        var worksheet = workbook.addWorksheet(entityName);
