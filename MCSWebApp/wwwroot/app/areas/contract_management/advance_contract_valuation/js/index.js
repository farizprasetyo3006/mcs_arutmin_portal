$(function () {
    ...
    $("#grid").dxDataGrid({
        ...
        onRowUpdated: function (e) {
            $.ajax({
                url: "api/" + areaName + "AdvanceContractValuationDetail/GetTotalById/" + currentRecord.id,
                type: 'GET',
                ...
                success: function (response) {
                    currentRecord.total = response.total || 0;
                    setTimeout(function () {
        ...
        return function () {
            ...
            return $("<div>")
                .dxDataGrid({
                    ...
                    onRowUpdated: function (e) {
                        $.ajax({
                            url: "/api/ContractManagement/AdvanceContractValuationDetail/GetTotalById/" + currentRecord.id,
                            type: 'GET',
                            contentType: "application/json",
                            beforeSend: function (xhr) {
                                xhr.setRequestHeader("Authorization", "Bearer " + token);
