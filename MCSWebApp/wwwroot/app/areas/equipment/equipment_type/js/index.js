$(function () {
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
           ...
           /* {
            ...
            {
                dataField: "item_class",
                dataType: "text",
                caption: "Item Class",
                lookup: {
                    dataSource: DevExpress.data.AspNet.createStore({
                        key: "value",
                        loadUrl: "/api/General/MasterList/ItemClass",
                        onBeforeSend: function (method, ajaxOptions) {
                            ajaxOptions.xhrFields = { withCredentials: true };
                            ajaxOptions.beforeSend = function (request) {
                                request.setRequestHeader("Authorization", "Bearer " + token);
        ...
        onEditorPreparing: function (e) {
            ...
            if (e.parentType === "dataRow" && e.dataField === "equipment_type_code") {
                e.editorOptions.disabled = e.row.data.equipment_type_code;
            }
        },
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Equipment/EquipmentType/UploadDocument",
                type: 'POST',
                cache: false,
