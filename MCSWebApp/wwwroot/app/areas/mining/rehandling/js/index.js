$(function () {
    ...
    var _loadUrl1 = "/api/Mining/Rehandling/CHLSRehandling/" + encodeURIComponent(formatTanggal(firstDay))
        + "/" + encodeURIComponent(formatTanggal(lastDay));
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            },
            {
                ...
                validationRules: [{
                    type: "required",
                    message: "This Shift field is required."
                }],
                lookup: {
                    dataSource: DevExpress.data.AspNet.createStore({
                        key: "value",
            ...
            },
            {
                ...
                //validationRules: [{
                //    type: "required",
                //    message: "This Distance field is required."
                //}],
                format: {
                    type: "fixedPoint",
                    precision: 2
                ...
                .dxDataGrid({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            lookup: {
                                dataSource: function (options) {
                                    var _url = "/api/Mining/CHLS/DestinationLocationIdLookup";
                                    return {
                                        store: DevExpress.data.AspNet.createStore({
                                            key: "value",
                                            loadUrl: _url,
    ...
    const saveApprovalForm = (formData) => {
        $.ajax({
            type: "POST",
            url: "/api/Mining/Rehandling/ApproveUnapprove",
            data: formData,
            processData: false,
            contentType: false,
            beforeSend: function (xhr) {
    ...
    $('#btnDownloadSelectedRow').on('click', function () {
        if (selectedIds != null && selectedIds != '') {
            ...
            $.ajax({
                url: "/Mining/Rehandling/ExcelExport",
                type: 'POST',
                cache: false,
                contentType: "application/json",
                ...
                if (data instanceof Blob) {
                    ...
                    a.href = url;
                    a.download = "Rehandling.xlsx"; // Set the appropriate file name here
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Mining/Rehandling/UploadDocument",
                type: 'POST',
                cache: false,
                contentType: "application/json",
