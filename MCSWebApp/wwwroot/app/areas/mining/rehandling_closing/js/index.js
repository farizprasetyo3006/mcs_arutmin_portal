$(function () {
    ...
    var areaName = "Mining";
    var entityName = "RehandlingClosing";
                ...
                $("<div>")
                    .dxDataGrid({
                        ...
                        onInitNewRow: function (e) {
                            e.data.rehandling_closing_id = currentRecord.id;
                        },
        ...
        onEditorPreparing: function (e) {
            ...
            if (e.parentType === "dataRow" && e.dataField === "from_date") {
                ...
                e.editorOptions.onValueChanged = function (e) { // Overiding the standard handler
                    ...
                    if (from_date !== null && to_date !== null) {
                        let cari = "/api/Mining/RehandlingClosing/RehandlingTotal"
            ...
            if (e.parentType === "dataRow" && e.dataField === "to_date") {
                ...
                e.editorOptions.onValueChanged = function (e) { // Overiding the standard handler
                    ...
                    if (from_date !== null && to_date !== null) {
                        let cari = "/api/Mining/RehandlingClosing/ProductionTotal"
                            + "?FromDate=" + encodeURIComponent(from_date.toISOString())
                            + "&ToDate=" + encodeURIComponent(to_date.toISOString());
                        $.ajax({
                            url: cari,
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Mining/RehandlingClosing/UploadDocument",
                type: 'POST',
                cache: false,
                contentType: "application/json",
