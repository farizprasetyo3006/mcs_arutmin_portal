$(function () {
                ...
                $("<div>")
                    .dxDataGrid({
                        ...
                        onInitNewRow: function (e) {
                            e.data.hauling_closing_id = currentRecord.id
                          //  e.data.business_area_id = currentRecord.business_unit_id
                        },
            ...
            if (e.parentType === "dataRow" && e.dataField === "from_date") {
                ...
                e.editorOptions.onValueChanged = function (e) { // Overiding the standard handler
                    ...
                    if (from_date !== null && to_date !== null) {
                        let cari = "/api/Mining/CoalMinedClosing/ProductionTotal"
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Mining/HaulingClosing/UploadDocument",
                type: 'POST',
                cache: false,
                contentType: "application/json",
