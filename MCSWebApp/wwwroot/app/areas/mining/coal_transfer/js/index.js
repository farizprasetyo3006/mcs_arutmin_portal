$(function () {
    ...
    var _loadUrl = url + "/DataGrid/" + encodeURIComponent(formatTanggal(firstDay))
        + "/" + encodeURIComponent(formatTanggal(lastDay));
    var _loadUrl1 = url + "/CHLSCoalTransfer/" + encodeURIComponent(formatTanggal(firstDay))
        + "/" + encodeURIComponent(formatTanggal(lastDay));
...
let approvalPopupOptions = {
    ...
    const saveApprovalForm = (formData) => {
        $.ajax({
            type: "POST",
            url: "/api/Mining/CoalTransfer/ApproveUnapprove",
            data: formData,
            processData: false,
            contentType: false,
            beforeSend: function (xhr) {
    ...
    $('#btnDownloadSelectedRow').on('click', function () {
        if (selectedIds != null && selectedIds != '') {
            ...
            $.ajax({
                url: "/Mining/CoalTransfer/ExcelExport",
                type: 'POST',
                cache: false,
                contentType: "application/json",
                ...
                if (data instanceof Blob) {
                    ...
                    a.href = url;
                    a.download = "CoalTransfer.xlsx"; // Set the appropriate file name here
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Mining/CoalTransfer/UploadDocument",
                type: 'POST',
                cache: false,
                contentType: "application/json",
