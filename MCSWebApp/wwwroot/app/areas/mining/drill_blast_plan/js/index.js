$(function () {
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            {
                dataField: "blasting_method_id",
                dataType: "string",
                caption: "Blasting Method",
                width: "130px",
                lookup: {
                    dataSource: function (options) {
                        return {
                            ...
                            filter: ["item_group", "=", "blasting-method"]
                        }
                    },
                    valueExpr: "value",
                    displayExpr: "text"
           ...
           /* {
            ...
            },*/
            {
                ...
                caption: "Quantity Explosive material",
                validationRules: [{
                    type: "required",
                    message: "Quantity Explosive material is required."
                }],
                formItem: {
                    colSpan: 2,
                }
                ...
                lookup: {
                    dataSource: function (options) {
                        return {
                            store: DevExpress.data.AspNet.createStore({
                                key: "value",
                                loadUrl: "/api/Location/BusinessArea/BusinessAreaSubPitIdLookup",
                                onBeforeSend: function (method, ajaxOptions) {
                                    ajaxOptions.xhrFields = { withCredentials: true };
                                    ajaxOptions.beforeSend = function (request) {
                                        request.setRequestHeader("Authorization", "Bearer " + token);
                ...
                e.editorOptions.onValueChanged = function (e) { // Overiding the standard handler
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            grid.cellValue(index, "business_area_code", record.business_area_code);
                        }
                    })
