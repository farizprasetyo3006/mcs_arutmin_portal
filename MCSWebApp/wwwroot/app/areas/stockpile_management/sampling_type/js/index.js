$(function () {
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            {
                dataField: "sampling_type_name",
                dataType: "string",
                caption: "Sampling Type Name",
                validationRules: [{
                    type: "required",
            ...
            {
                dataField: "sampling_type_code",
                dataType: "string",
                caption: "Sampling Type Code",
                validationRules: [{
                    type: "required",
                    message: "This field is required."
                }]
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/StockpileManagement/SamplingType/UploadDocument",
                type: 'POST',
                cache: false,
