$(function () {
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            {
                dataField: "proved_reserve",
                dataType: "number",
                caption: "Proved Reserve"
            },
            {
                dataField: "total_extracted",
                dataType: "number",
                caption: "Total Extracted",
                allowEditing: false
            },
            {
                dataField: "uom_id",
            ...
            {
                dataField: "ready_to_get",
                dataType: "boolean",
                caption: "Ready to Get",
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/StockpileManagement/Reserve/UploadDocument",
                type: 'POST',
                cache: false,
