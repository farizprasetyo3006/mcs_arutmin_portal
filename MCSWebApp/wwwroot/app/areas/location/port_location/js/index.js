$(function () {
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            {
                dataField: "port_location_code",
                dataType: "string",
                caption: "Port Location Code",
                validationRules: [{
                    type: "required",
                    message: "This field is required."
                }]
        ...
        onEditorPreparing: function (e) {
            if (e.parentType === "dataRow" && e.dataField == "port_location_code") {
                if (e.row.isNewRow) {
                    // This is a new row, allow editing
                    e.editorOptions.disabled = false;
                } else {
                    // This is an existing row, disable if code is not null
                    e.editorOptions.disabled = e.row.data.port_location_code !== null;
                }
            }
                ...
                e.editorOptions.onValueChanged = function (innerE) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            grid.beginUpdate();
                            grid.cellValue(index, "port_location_code", record.business_area_code)
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Location/PortLocation/UploadDocument",
                type: 'POST',
                cache: false,
                contentType: "application/json",
