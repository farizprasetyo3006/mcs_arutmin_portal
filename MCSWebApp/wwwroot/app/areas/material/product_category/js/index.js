$(function () {
    ...
    var entityName = "ProductCategory";
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            {
                dataField: "product_category_code",
                dataType: "string",
        ...
        onEditorPreparing: function (e) {
            ...
            if (e.parentType === "dataRow" && e.dataField == "product_category_code") {
                e.editorOptions.disabled = e.row.data.product_category_code != null
            }
        },
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Material/ProductCategory/UploadDocument",
                type: 'POST',
                cache: false,
