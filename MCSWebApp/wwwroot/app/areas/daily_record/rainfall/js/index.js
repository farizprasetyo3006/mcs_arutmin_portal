$(function () {
    ...
    var tgl1 = sessionStorage.getItem("rainfallDate1");
    var tgl2 = sessionStorage.getItem("rainfallDate2");
    ...
    $("#date-box1").dxDateBox({
        ...
        onValueChanged: function (data) {
            ...
            sessionStorage.setItem("rainfallDate1", formatTanggal(firstDay));
    ...
    $("#date-box2").dxDateBox({
        ...
        onValueChanged: function (data) {
            ...
            sessionStorage.setItem("rainfallDate2", formatTanggal(lastDay));
            _loadUrl = url + "/DataGrid/" + encodeURIComponent(formatTanggal(firstDay))
                + "/" + encodeURIComponent(formatTanggal(lastDay));
        }
    });
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            },
            {
                ...
                //validationRules: [{
                //    type: "required",
                //    message: "The Rainfall Value field is required."
                //}]
            },
            {
                dataField: "rainfall_value",
                dataType: "number",
                caption: "Rainfall Value (mm)",
                validationRules: [{
                    type: "required",
                    message: "The Rainfall Value field is required."
                }],
    ...
    $('#btnDownloadSelectedRow').on('click', function () {
        if (selectedIds != null && selectedIds != '') {
            ...
            $.ajax({
                url: "/dailyrecord/rainfall/ExcelExport",
                type: 'POST',
                cache: false,
                contentType: "application/json",
                data: JSON.stringify(payload),
                ...
                if (data instanceof Blob) {
                    ...
                    a.href = url;
                    a.download = "Rainfall.xlsx"; // Set the appropriate file name here
