$(function () {
    ...
    var tgl1 = sessionStorage.getItem("hazeDate1");
    var tgl2 = sessionStorage.getItem("hazeDate2");
    ...
    $("#date-box1").dxDateBox({
        ...
        onValueChanged: function (data) {
            ...
            sessionStorage.setItem("hazeDate1", formatTanggal(firstDay));
    ...
    $("#date-box2").dxDateBox({
        ...
        onValueChanged: function (data) {
            ...
            sessionStorage.setItem("hazeDate2", formatTanggal(lastDay));
            _loadUrl = url + "/DataGrid/" + encodeURIComponent(formatTanggal(firstDay))
                + "/" + encodeURIComponent(formatTanggal(lastDay));
        }
    });
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            {
                dataField: "haze_value",
                dataType: "number",
                caption: "Haze Value (hour)",
                validationRules: [{
                    type: "required",
                    message: "The Haze Value field is required."
                }],
    ...
    $('#btnDownloadSelectedRow').on('click', function () {
        if (selectedIds != null && selectedIds != '') {
            ...
            $.ajax({
                url: "/dailyrecord/haze/ExcelExport",
                type: 'POST',
                cache: false,
                contentType: "application/json",
                data: JSON.stringify(payload),
                ...
                if (data instanceof Blob) {
                    ...
                    a.href = url;
                    a.download = "Haze.xlsx"; // Set the appropriate file name here
