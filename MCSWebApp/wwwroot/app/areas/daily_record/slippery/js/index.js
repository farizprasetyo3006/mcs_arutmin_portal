$(function () {
    ...
    var tgl1 = sessionStorage.getItem("slipperyDate1");
    var tgl2 = sessionStorage.getItem("slipperyDate2");
    ...
    $("#date-box1").dxDateBox({
        ...
        onValueChanged: function (data) {
            ...
            sessionStorage.setItem("slipperyDate1", formatTanggal(firstDay));
    ...
    $("#date-box2").dxDateBox({
        ...
        onValueChanged: function (data) {
            ...
            sessionStorage.setItem("slipperyDate2", formatTanggal(lastDay));
            _loadUrl = url + "/DataGrid/" + encodeURIComponent(formatTanggal(firstDay))
                + "/" + encodeURIComponent(formatTanggal(lastDay));
        }
    });
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            {
                dataField: "slippery_value",
                dataType: "number",
                caption: "Slippery Value (hour)",
                validationRules: [{
                    type: "required",
                    message: "The Slippery Value field is required."
                }],
            ...
            //{
            //    dataField: "rainfall_delay",
            //    dataType: "number",
            //    caption: "Rainfall Delay (hour) ",
            //    editorType: "dxNumberBox",
            //    format: {
            //        type: "fixedPoint",
            //        precision: 3
    ...
    $('#btnDownloadSelectedRow').on('click', function () {
        if (selectedIds != null && selectedIds != '') {
            ...
            $.ajax({
                url: "/dailyrecord/slippery/ExcelExport",
                type: 'POST',
                cache: false,
                contentType: "application/json",
                data: JSON.stringify(payload),
                ...
                if (data instanceof Blob) {
                    ...
                    a.href = url;
                    a.download = "Slippery.xlsx"; // Set the appropriate file name here
