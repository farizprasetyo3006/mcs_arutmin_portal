$(function () {
        ...
        columns: [
            {
                ...
                lookup: {
                    dataSource: DevExpress.data.AspNet.createStore({
                        ...
                        //loadUrl: "/api/Equipment/EquipmentIncident/EquipmentIdLookup",
                        onBeforeSend: function (method, ajaxOptions) {
                            ajaxOptions.xhrFields = { withCredentials: true };
                            ajaxOptions.beforeSend = function (request) {
                                request.setRequestHeader("Authorization", "Bearer " + token);
                ...
                lookup: {
                    dataSource: function (options) {
                        return {
                            ...
                            filter: ["item_group", "=", "accident-category"]
                        }
                    },
                    valueExpr: "value",
                    displayExpr: "text"
            ...
            {
                dataField: "hour_duration",
                dataType: "number",
                caption: "Hour Duration",
                allowEditing: false
            },
            {
                dataField: "incident_description",
                dataType: "string",
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Equipment/HSELTI/UploadDocument",
                type: 'POST',
                cache: false,
