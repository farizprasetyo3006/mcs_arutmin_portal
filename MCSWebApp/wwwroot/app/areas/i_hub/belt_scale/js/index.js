$(function () {
    ...
    var tgl1 = sessionStorage.getItem("beltscaleDate1");
    var tgl2 = sessionStorage.getItem("beltscaleDate2");
    ...
    $("#date-box1").dxDateBox({
        ...
        onValueChanged: function (data) {
            ...
            sessionStorage.setItem("beltscaleDate1", formatTanggal(firstDay));
    ...
    $("#date-box2").dxDateBox({
        ...
        onValueChanged: function (data) {
            ...
            sessionStorage.setItem("beltscaleDate2", formatTanggal(lastDay));
            _loadUrl = url + "/DataGrid/" + encodeURIComponent(formatTanggal(firstDay))
                + "/" + encodeURIComponent(formatTanggal(lastDay));
        }
    });
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            },
            {
                ...
                validationRules: [{
                    type: "required",
                    message: "The Equipment Id field is required."
                }]
            },
            {
                ...
                validationRules: [{
                    type: "required",
                    message: "The Loading Rate field is required."
                }]
            },
            {
                dataField: "quantity",
            ...
            {
                dataField: "respon_text",
                dataType: "text",
                caption: "Respon Text",
                validationRules: [{
                    type: "required",
                    message: "The Respon Text field is required."
                }],
            }
            /*{
                dataField: "shift_id",
