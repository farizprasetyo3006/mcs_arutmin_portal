$(function () {
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
                        ...
                        if (options !== undefined && options !== null) {
                            if (options.data !== undefined && options.data !== null) {
                                if (options.data.destination_location_id !== undefined
                                    ...
                                    _url += "?LocationId=" + encodeURIComponent(options.data.destination_location_id);
                                }
                            }
                        }
            ...
            },
            {
                ...
                dataType: "datetime",
                caption: "Berth DateTime",
                visible: false
            },
            {
                dataField: "start_loading_datetime",
                dataType: "datetime",
                caption: "Start Loading",
                visible: false
            },
            {
                dataField: "end_loading_datetime",
                dataType: "datetime",
                caption: "End Loading",
                visible: false
            },
                ...
                $("<div>")
                    .dxDataGrid({
                        ...
                        columns: [
                            ...
                            {
                                dataField: "despatch_order_delay_id",
                                dataType: "string",
                                caption: "Incident Category",
                                lookup: {
                                    dataSource: DevExpress.data.AspNet.createStore({
                                        key: "value",
                                        loadUrl: urlDetail + "/DespatchOrderDelayIdLookup/" + encodeURIComponent(currentRecord.id),
                                        onBeforeSend: function (method, ajaxOptions) {
                                            ajaxOptions.xhrFields = { withCredentials: true };
                                            ajaxOptions.beforeSend = function (request) {
                                                request.setRequestHeader("Authorization", "Bearer " + token);
    ...
    $('#btnUpload').on('click', function () {
        ...
        reader.onload = function () {
            ...
            $.ajax({
                url: "/api/Port/Shipping/UploadDocument",
                type: 'POST',
                cache: false,
