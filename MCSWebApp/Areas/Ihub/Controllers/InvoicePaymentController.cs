...
namespace MCSWebApp.Areas.Ihub.Controllers
{
    ...
    public class InvoicePaymentController : BaseController
    {
        ...
        public InvoicePaymentController(IConfiguration Configuration)
            : base(Configuration)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Breadcrumb = WebAppMenu.BreadcrumbText[WebAppMenu.InvoicePayment];
            ViewBag.BreadcrumbCode = WebAppMenu.InvoicePayment;
