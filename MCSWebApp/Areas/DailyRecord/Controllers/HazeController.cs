...
{
    [Area("DailyRecord")]
    public class HazeController : BaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;

        public HazeController(IConfiguration Configuration)
            : base(Configuration)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Breadcrumb = WebAppMenu.BreadcrumbText[WebAppMenu.Haze];
            ViewBag.BreadcrumbCode = WebAppMenu.Haze;
        ...
        public async Task<IActionResult> ExcelExport([FromBody] dynamic Data)
        {
            ...
            using (var fs = new FileStream(Path.Combine(FilePath, sFileName), FileMode.Create, FileAccess.Write))
            {
                ...
                ISheet excelSheet = workbook.CreateSheet("Haze");
                ...
                if (Data != null && Data.selectedIds != null)
                {
                    var selectedIds = ((string)Data.selectedIds)
                        ...
                        .ToList();
                    var tabledata = dbContext.haze.Where(o => o.organization_id == CurrentUserContext.OrganizationId && selectedIds.Contains(o.id))
