...
{
    [Area("Mining")]
    public class LandClearingController : BaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;

        public LandClearingController(IConfiguration Configuration)
            : base(Configuration)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Breadcrumb = WebAppMenu.BreadcrumbText[WebAppMenu.LandClearing];
            ViewBag.BreadcrumbCode = WebAppMenu.LandClearing;
        ...
        public async Task<IActionResult> ExcelExport()
        {
            ...
            using (var fs = new FileStream(Path.Combine(FilePath, sFileName), FileMode.Create, FileAccess.Write))
            {
                ...
                foreach (var baris in tabledata)
                {
                    ...
                    row.CreateCell(7).SetCellValue(Convert.ToDouble(baris.unloading_quantity));
                    ...
                    row.CreateCell(18).SetCellValue(advance_contract_number);
