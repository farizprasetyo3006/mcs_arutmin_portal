...
{
    [Area("Mining")]
    public class RehandlingClosingController : BaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;

        public RehandlingClosingController(IConfiguration Configuration)
            : base(Configuration)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Breadcrumb = WebAppMenu.BreadcrumbText[WebAppMenu.RehandlingClosing];
            ViewBag.BreadcrumbCode = WebAppMenu.RehandlingClosing;
        ...
        {
            string sFileName = "Rehandling Closing.xlsx";
            ...
            using (var fs = new FileStream(Path.Combine(FilePath, sFileName), FileMode.Create, FileAccess.Write))
            {
                ...
                ISheet excelSheet = workbook.CreateSheet("Rehandling Closing");
                ...
                var dataTable = await dbContext.rehandling_closing
                ...
                foreach (var data in dataTable)
                {
                    ...
                    var itemData = await dbContext.rehandling_closing_item
                        .Where(x => x.rehandling_closing_id == data.id).ToListAsync();
                    int iCount = 1;
