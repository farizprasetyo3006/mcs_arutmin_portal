...
{
    [Area("Mining")]
    public class CoalTransferClosingController : BaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;

        public CoalTransferClosingController(IConfiguration Configuration)
            : base(Configuration)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Breadcrumb = WebAppMenu.BreadcrumbText[WebAppMenu.CoalTransferClosing];
            ViewBag.BreadcrumbCode = WebAppMenu.CoalTransferClosing;
        ...
        {
            string sFileName = "Coal Transfer Closing.xlsx";
            ...
            using (var fs = new FileStream(Path.Combine(FilePath, sFileName), FileMode.Create, FileAccess.Write))
            {
                ...
                ISheet excelSheet = workbook.CreateSheet("Coal Transfer Closing");
                ...
                var dataTable = await dbContext.coal_transfer_closing
                ...
                foreach (var data in dataTable)
                {
                    ...
                    var itemData = await dbContext.coal_transfer_closing_item
                        .Where(x => x.coal_transfer_closing_id == data.id).ToListAsync();
                    int iCount = 1;
