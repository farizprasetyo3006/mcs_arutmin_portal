...
{
    [Area("Mining")]
    public class HaulingClosingController : BaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;

        public HaulingClosingController(IConfiguration Configuration)
            : base(Configuration)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Breadcrumb = WebAppMenu.BreadcrumbText[WebAppMenu.HaulingClosing];
            ViewBag.BreadcrumbCode = WebAppMenu.HaulingClosing;
        ...
        {
            string sFileName = "Hauling Closing.xlsx";
            ...
            using (var fs = new FileStream(Path.Combine(FilePath, sFileName), FileMode.Create, FileAccess.Write))
            {
                ...
                ISheet excelSheet = workbook.CreateSheet("Hauling Closing");
                ...
                var dataTable = await dbContext.hauling_closing
                ...
                foreach (var data in dataTable)
                {
                    ...
                    var itemData = await dbContext.hauling_closing_item
                        .Where(x => x.hauling_closing_id == data.id).ToListAsync();
                    int iCount = 1;
