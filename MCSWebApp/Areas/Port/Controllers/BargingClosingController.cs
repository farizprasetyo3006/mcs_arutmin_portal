...
{
    [Area("Port")]
    public class BargingClosingController : BaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;

        public BargingClosingController(IConfiguration Configuration)
            : base(Configuration)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Breadcrumb = WebAppMenu.BreadcrumbText[WebAppMenu.BargingClosing];
            ViewBag.BreadcrumbCode = WebAppMenu.BargingClosing;
        ...
        {
            string sFileName = "Barging Closing.xlsx";
            ...
            using (var fs = new FileStream(Path.Combine(FilePath, sFileName), FileMode.Create, FileAccess.Write))
            {
                ...
                ISheet excelSheet = workbook.CreateSheet("Barging Closing");
                ...
                var dataTable = await dbContext.barging_closing
                ...
                foreach (var data in dataTable)
                {
                    ...
                    var itemData = await dbContext.barging_closing_item
                        .Where(x => x.barging_closing_id == data.id).ToListAsync();
                    int iCount = 1;
