...
namespace MCSWebApp.Areas.StockpileManagement.Controllers
{
    ...
    public class StockpileSummaryController : BaseController
    {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        private readonly mcsContext dbContext;

        public StockpileSummaryController(IConfiguration Configuration)
            : base(Configuration)
        {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Breadcrumb = WebAppMenu.BreadcrumbText[WebAppMenu.StockpileSummary];
            ViewBag.BreadcrumbCode = WebAppMenu.StockpileSummary;
        ...
        {
            string sFileName = "StockpileStateSummary.xlsx";
