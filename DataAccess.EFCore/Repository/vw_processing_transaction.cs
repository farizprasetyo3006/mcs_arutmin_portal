...
{
    public partial class vw_processing_transaction
    {
        ...
        public string source_uom_name { get; set; }
        ...
        public string destination_product_name { get; set; }
        ...
        public string destination_uom_name { get; set; }
