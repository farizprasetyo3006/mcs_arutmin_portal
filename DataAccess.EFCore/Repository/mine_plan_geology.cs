...
{
    public partial class mine_plan_geology
    {
        public mine_plan_geology()
        {
            mineplan_geology_history = new HashSet<mineplan_geology_history>();
        }
        ...
        public virtual ICollection<mineplan_geology_history> mineplan_geology_history { get; set; }
    }
}
